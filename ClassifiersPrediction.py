...
if __name__ == '__main__':
    user_trainingfile = input("Please write the of the training file ")       #SEM-2012-SharedTask-CD-SCO-training-simple1.txt
    user_testingfile = input("Please write the of the testing file ")          #SEM-2012-SharedTask-CD-SCO-dev-simple1.txt
    argv = ['python', user_testingfile, user_trainingfile, 'final.txt'  ]
    main(argv)
