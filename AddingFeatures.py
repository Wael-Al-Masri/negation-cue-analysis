...
if __name__ == '__main__':
    argv = ['python','SEM-2012-SharedTask-CD-SCO-simple\SEM-2012-SharedTask-CD-SCO-training-simple.txt','SEM-2012-SharedTask-CD-SCO-simple\SEM-2012-SharedTask-CD-SCO-training-simple1.txt']
    main(argv)
    print("done")
